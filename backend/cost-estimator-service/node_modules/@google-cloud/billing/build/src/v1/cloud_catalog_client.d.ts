...
export declare class CloudCatalogClient {
    ...
    */
     ...
     */
    billingAccountsPath(billingAccount: string): string;
    /**
     ...
     */
    matchBillingAccountFromBillingAccountsName(billingAccountsName: string): string | number;
    /**
     ...
     * @returns {string} Resource name string.
     */
    organizationBillingAccountsPath(organization: string, billingAccount: string): string;
    /**
     ...
     */
    matchOrganizationFromOrganizationBillingAccountsName(organizationBillingAccountsName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the billing_account.
     */
    matchBillingAccountFromOrganizationBillingAccountsName(organizationBillingAccountsName: string): string | number;
    /**
