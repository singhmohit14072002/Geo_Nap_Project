...
class CloudBillingClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            billingAccountsPathTemplate: new this._gaxModule.PathTemplate('billingAccounts/{billing_account}'),
            organizationPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}'),
            organizationBillingAccountsPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/billingAccounts/{billing_account}'),
    ...
    initialize() {
        ...
        const cloudBillingStubMethods = ['getBillingAccount', 'listBillingAccounts', 'updateBillingAccount', 'createBillingAccount', 'listProjectBillingInfo', 'getProjectBillingInfo', 'updateProjectBillingInfo', 'getIamPolicy', 'setIamPolicy', 'testIamPermissions', 'moveBillingAccount'];
     ...
     */
    billingAccountsPath(billingAccount) {
     ...
     */
    matchBillingAccountFromBillingAccountsName(billingAccountsName) {
     ...
     * @returns {string} Resource name string.
     */
    organizationBillingAccountsPath(organization, billingAccount) {
     ...
     * @returns {string} A string representing the organization.
     */
    matchOrganizationFromOrganizationBillingAccountsName(organizationBillingAccountsName) {
     ...
     * @returns {string} A string representing the billing_account.
     */
    matchBillingAccountFromOrganizationBillingAccountsName(organizationBillingAccountsName) {
