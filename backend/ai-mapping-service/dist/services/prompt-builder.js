...
exports.buildMappingPrompt = void 0;
const requirement_schema_1 = require("../schemas/requirement.schema");
const buildMappingPrompt = (input) => {
    return [
        ...
        JSON.stringify(requirement_schema_1.requirementSchemaTemplate, null, 2),
        "",
        "Schema contract (must be followed strictly):",
        JSON.stringify(requirement_schema_1.requirementSchemaContract, null, 2),
        "",
        "Input payload:",
